...
const HeroSection = () => (
  <section className="relative z-10 pt-20 pb-12 text-center">
    ...
    <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-12 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
      <button className="px-7 py-3.5 rounded-xl font-bold text-[15px] text-primary-foreground shadow-cta transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg"
      ...
      <div className="text-left">
        ...
        <div className="border-2 border-dashed border-primary/30 rounded-2xl bg-background h-[110px] flex items-center justify-center gap-2 text-subtle text-sm cursor-pointer hover:border-primary/50 transition-colors">
